...
class Connection extends Nette\Object
{
	...
	/** @var int Time in secconds */
	private $lastInteraction = 0;
	
	/** @var int Time in secconds. Default setting in my.conf is 28800*/
	private $interactionTimeout = 20000;
	...
	private function checkTimeout(){
		if(time() - $this->lastInteraction >= $this->interactionTimeout) {
